...
var $number = (0, _jquery.default)("#number"); //获得当前值，并保存起来

var n = localStorage.getItem("n");
$number.text(n || 100); //绑定事件,获得数值并参与运算
...
var $tabContent = (0, _jquery.default)('#app2 .tab-content'); //用事件委托，监听li的点击事件

$tabBar.on('click', 'li', function (e) {
  //获得事件绑定元素的下标$li.index()
  var $li = (0, _jquery.default)(e.currentTarget);
  $li.addClass('selected').siblings().removeClass('selected');
  var index = $li.index(); //通过内容的下标，添加一个active类和删除兄弟类
